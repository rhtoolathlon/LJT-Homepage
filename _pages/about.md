...
I am a first-year Ph.D. candidate at the **HKUST NLP Group**, supervised by **Professor Junxian He**. My research focuses on natural language processing and machine learning. I graduated from **Shanghai Jiao Tong University (SJTU)** with a B.Eng. degree in June 2024.
...
1. **Junteng Liu**, Yuanxiang Fan, Zhuo Jiang, Han Ding, Yongyi Hu, Chi Zhang, Yiqi Shi, Shitong Weng, Aili Chen, Shiqi Chen, Yunan Huang, Mozhi Zhang, Pengyu Zhao, Junjie Yan, Junxian He. "SynLogic: Synthesizing Verifiable Reasoning Data at Scale for Learning Logical Reasoning and Beyond." 2025. [[arXiv]](https://arxiv.org)

2. **Junteng Liu**, Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. "On the Perception Bottleneck of VLMs for Chart Understanding." 2025. [[arXiv]](https://arxiv.org)

3. **Junteng Liu**, Shiqi Chen, Yu Cheng, Junxian He. "On the Universal Truthfulness Hyperplane Inside LLMs." *EMNLP 2024*. [[arXiv]](https://arxiv.org)
